                      ...
                      {error.errors.email?.message}
                                ...
                                <div className="col-span-6 pr-2">
                                    ...
                                    <input
                                        ...
                                        {...register("password")}
                                    />
                                    {error.errors.password ? (<span className="text-red-600">{error.errors.password?.message}</span>) : ("")}
                                </div>
                                <div className="col-span-6 pl-2 ">
                                    ...
                                    />
                                    {error.errors.confirmPassword ? (<span className="text-red-600">{error.errors.confirmPassword?.message}</span>) : ("")}
                                </div>
