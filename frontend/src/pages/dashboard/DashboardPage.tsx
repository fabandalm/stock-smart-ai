  ...
  return (
    <div className={`w-full m-0 min-h-screen ${isLoggedIn() ? "sm:ps-64" : "p-0"}`}>
      ...
      <main className="p-6 md:p-8 max-w-7xl mx-auto space-y-8">
        {/* Welcome & AI Header */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-[#0f192d] via-[#1a2948] to-[#0f192d] p-6 rounded-3xl border border-[#2b3e64] shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 -mt-8 -mr-8 w-64 h-64 bg-[#425D94]/20 rounded-full blur-3xl pointer-events-none"></div>
          
          <div className="relative z-10">
            <div className="flex items-center space-x-3 mb-2">
              <span className="px-3 py-1 text-xs font-semibold rounded-full bg-[#425D94]/30 text-[#8cb0f5] border border-[#425D94]/50">
                ✨ Intelligent Stock Telemetry
              </span>
            </div>
            <h1 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight">
              Welcome back, <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#7195de] to-[#a3c0fa]">{user?.userName || "Operator"}</span> 👋
            </h1>
          ...
          <div className="flex items-center gap-3 relative z-10">
            <button className="px-4 py-2.5 rounded-xl bg-[#14213d]/80 hover:bg-[#1a2b50] text-slate-200 text-sm font-medium border border-[#2c4068] transition-all flex items-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
              Export Metrics
            </button>
            <button className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#425D94] to-[#5c7ebc] hover:from-[#374e7d] hover:to-[#4e6eb0] text-white text-sm font-semibold shadow-lg shadow-[#425D94]/30 transition-all flex items-center gap-2 hover:scale-105 active:scale-95">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          {isLoading ? (
            ...
            <div className="group p-5 rounded-2xl bg-[#121c31]/90 border border-[#233557] hover:border-[#425D94] transition-all duration-300 shadow-xl relative overflow-hidden">
          ...
          {isLoading ? (
            ...
            <div className="group p-5 rounded-2xl bg-[#121c31]/90 border border-[#233557] hover:border-[#425D94] transition-all duration-300 shadow-xl relative overflow-hidden">
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 rounded-xl bg-[#425D94]/20 text-[#7ca0e6] flex items-center justify-center border border-[#425D94]/30 group-hover:scale-110 transition-transform">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {isLoading ? (
            ...
            <div className="group p-5 rounded-2xl bg-[#121c31]/90 border border-[#233557] hover:border-rose-500/50 transition-all duration-300 shadow-xl relative overflow-hidden">
              <div className="flex items-center justify-between">
          ...
          {isLoading ? (
            ...
            <div className="group p-5 rounded-2xl bg-[#121c31]/90 border border-[#233557] hover:border-emerald-500/50 transition-all duration-300 shadow-xl relative overflow-hidden">
              <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Main Area Chart */}
          <div className="lg:col-span-8 p-6 rounded-3xl bg-[#121c31]/90 border border-[#233557] shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-2">
                <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium bg-[#1a2948] text-slate-200 border border-[#2c4068]">
                  Last 30 Days
                </span>
              </div>
            </div>
            <div className="p-2 rounded-2xl bg-[#0a101d]/60 border border-[#1d2d4a]">
              <AreaCharts />
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6 flex flex-col justify-between">
            <div className="p-6 rounded-3xl bg-[#121c31]/90 border border-[#233557] shadow-2xl">
              <div className="mb-4">
