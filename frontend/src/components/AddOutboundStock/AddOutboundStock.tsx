...
interface ModelProps {
  isOpen: boolean;
  onClose: (data?: AddOutboundStockDTO) => void; // A function type that takes no arguments and returns void
}
export interface AddOutboundStockDTO {
  productId: number;
  destination: string;
  quantity: number;
  date: Date;
...
const AddOutboundStock = (props: ModelProps) => {
  const [FormsValues, setFormsValues] = useState<AddOutboundStockDTO>({
    date: new Date(),
    productId: 0,
    destination: "",
    quantity: 0,
          ...
          <form
            ...
            <div className="grid gap-4 mb-4 grid-cols-12">
              ...
              <div className="col-span-6 sm:col-span-6">
                ...
                <select id="product" value={FormsValues?.productId || ""}
                  onChange={(e) => {
                    setFormsValues((prev) => ({
                      ...prev,
...
export default AddOutboundStock;
